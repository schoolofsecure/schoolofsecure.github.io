...
const STORAGE_KEY = 'ugy6_progress';
const STORAGE_COMPLETED_KEY = 'ugy6_completed';
...
const Ugy6 = () => {
  ...
  useEffect(()=>{
    const STEP_IMAGES = ['/images/6a.jpg','/images/6b.jpg','/images/6c.jpg','/images/6d.jpg','/images/6e.jpg'];
    const next = step + 1;
  ...
  useEffect(() => {
    try {
      ...
      if (isAuthenticated) {
        saveLevelCompletion('ugy6').catch(console.warn)
      }
    } catch(e) {
        ...
        <main>
          <div className="card" style={{textAlign:'center', padding:'40px 20px'}}>
            ...
            <p className="muted" style={{margin:'0 0 20px', fontSize:'16px', lineHeight:'1.7'}}>
              A 6. pálya csak az első két pálya teljesítése után érhető el.
              <br />
  ...
  return (
    <div className="container">
      ...
      <main>
        <NarrativeBlock badge="szivárgó port">
          <h1 style={{margin:'10px 0 4px'}}>A Szivárgó Port – Ügy #6</h1>
          ...
          <TaskCard title="1. feladat">
            <div className="grid2">
              ...
              <div className="card">
                ...
                />
                <div className="task-note"><PerfImg className="task-ill" src="/images/6a.jpg" alt="Illusztráció 6a" width="280" height="280" priority /></div>
                <div className="hint">
                  <details>
          ...
          <TaskCard title="2. feladat">
            <div className="grid2">
              ...
              <div className="card">
                ...
                <div className="task-note"><PerfImg className="task-ill" src="/images/6b.jpg" alt="Illusztráció 6b" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
          ...
          <TaskCard title="3. feladat">
            <div className="grid2">
              ...
              <div className="card">
                <h3>Válasz</h3>
                <ChallengeInput placeholder="megoldás…" onCheck={() => false} />
                <div className="task-note"><PerfImg className="task-ill" src="/images/6c.jpg" alt="Illusztráció 6c" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
          ...
          <TaskCard title="4. feladat">
            <div className="grid2">
              ...
              <div className="card">
                <h3>Válasz</h3>
                <ChallengeInput placeholder="megoldás…" onCheck={() => false} />
                <div className="task-note"><PerfImg className="task-ill" src="/images/6d.jpg" alt="Illusztráció 6d" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
          ...
          <TaskCard title="5. feladat">
            <div className="grid2">
              ...
              <div className="card">
                <h3>Válasz</h3>
                <ChallengeInput placeholder="megoldás…" onCheck={() => false} />
                <div className="task-note"><PerfImg className="task-ill" src="/images/6e.jpg" alt="Illusztráció 6e" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
                    onClick={() => { 
                      markDone(4); 
                      try {
                        localStorage.setItem('ugy6_completed', 'true');
                        if (isAuthenticated) {
                          saveLevelCompletion('ugy6').catch(console.warn)
                        }
                      } catch(e) {
                ...
                {done[4] && (
                  <div className="card" style={{marginTop:'10px', animation:'fadeIn .3s ease both'}}>
                    <div style={{display:'flex', gap:'10px', marginTop:'8px', flexWrap:'wrap'}}>
                      ...
                      <Link className="btn-ghost" to="/ugy5" style={{textDecoration:'none'}}>Előző ügy</Link>
                      <Link className="btn-ghost" to="/ugy7?start=1" style={{textDecoration:'none'}}>Következő ügy</Link>
                    </div>
                  </div>
                )}
              </div>
