...
function saveProgress(step, done) {
  try {
    ...
    if (window.CMAuth && window.CMAuth.isAuthenticated) {
      window.CMAuth.saveLevelCompletion('ugy6');
    }
  } catch(e) {
                ...
                {done[4] && (
                  <div className="card" style={{marginTop:'10px', animation:'fadeIn .3s ease both'}}>
                    <div style={{display:'flex', gap:'10px', marginTop:'8px', flexWrap:'wrap'}}>
                      ...
                      <a className="btn-ghost" href="/ugy5.html" style={{textDecoration:'none'}}>Előző ügy</a>
                      <a className="btn-ghost" href="/ugy7.html?start=1" style={{textDecoration:'none'}}>Következő ügy</a>
                    </div>
                  </div>
                )}
              </div>
