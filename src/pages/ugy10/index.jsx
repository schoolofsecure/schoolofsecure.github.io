...
const STORAGE_KEY = 'ugy10_progress';
const STORAGE_COMPLETED_KEY = 'ugy10_completed';
...
function saveProgress(step, done) {
  try {
    ...
    if (window.CMAuth && window.CMAuth.isAuthenticated) {
      window.CMAuth.saveLevelCompletion('ugy10');
    }
  } catch(e) {
...
const App = () => {
  ...
  useEffect(()=>{
    const STEP_IMAGES = ['/images/10a.jpg','/images/10b.jpg','/images/10c.jpg','/images/10d.jpg','/images/10e.jpg'];
    const next = step + 1;
      ...
      <div className="container">
        <header>
          <a href="/" className="brand" aria-label="CyberMystery – Vissza a főoldalra">
            ...
            <div>A Phantom‑Profil – Ügy #10</div>
          </a>
        </header>
        <main>
          <div className="card" style={{textAlign:'center', padding:'40px 20px'}}>
            ...
            <p className="muted" style={{margin:'0 0 20px', fontSize:'16px', lineHeight:'1.7'}}>
              A 10. pálya csak az első két pálya teljesítése után érhető el.
              <br />
  ...
  return (
    <div className="container">
      ...
      <main>
        <NarrativeBlock badge="phantom profil">
          <h1 style={{margin:'10px 0 4px'}}>A Phantom‑Profil – Ügy #10</h1>
          ...
          <TaskCard title="1. feladat">
            <div className="grid2">
              <div className="card">
                <h3>Első feladat</h3>
                <p className="muted">
                  Ez az első feladat a 10. pályán. 
              ...
              <div className="card">
                ...
                />
                <div className="task-note"><PerfImg className="task-ill" src="/images/10a.jpg" alt="Illusztráció 10a" width="280" height="280" priority /></div>
                <div className="hint">
                  <details>
          ...
          <TaskCard title="2. feladat">
            <div className="grid2">
              ...
              <div className="card">
                ...
                <div className="task-note"><PerfImg className="task-ill" src="/images/10b.jpg" alt="Illusztráció 10b" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
          ...
          <TaskCard title="3. feladat">
            <div className="grid2">
              ...
              <div className="card">
                <h3>Válasz</h3>
                <ChallengeInput placeholder="megoldás…" onCheck={() => false} />
                <div className="task-note"><PerfImg className="task-ill" src="/images/10c.jpg" alt="Illusztráció 10c" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
          ...
          <TaskCard title="4. feladat">
            <div className="grid2">
              ...
              <div className="card">
                <h3>Válasz</h3>
                <ChallengeInput placeholder="megoldás…" onCheck={() => false} />
                <div className="task-note"><PerfImg className="task-ill" src="/images/10d.jpg" alt="Illusztráció 10d" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
          ...
          <TaskCard title="5. feladat">
            <div className="grid2">
              ...
              <div className="card">
                <h3>Válasz</h3>
                <ChallengeInput placeholder="megoldás…" onCheck={() => false} />
                <div className="task-note"><PerfImg className="task-ill" src="/images/10e.jpg" alt="Illusztráció 10e" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
                    onClick={() => { 
                      markDone(4); 
                      try {
                        localStorage.setItem('ugy10_completed', 'true');
                        if (window.CMAuth && window.CMAuth.isAuthenticated) {
                          window.CMAuth.saveLevelCompletion('ugy10');
                        }
                      } catch(e) {
