...
const STORAGE_KEY = 'ugy5_progress';
const STORAGE_COMPLETED_KEY = 'ugy5_completed';
...
const Ugy5 = () => {
  ...
  useEffect(()=>{
    const STEP_IMAGES = ['/images/5a.jpg','/images/5b.jpg','/images/5c.jpg','/images/5d.jpg','/images/5e.jpg'];
    const next = step + 1;
  ...
  useEffect(() => {
    try {
      ...
      if (isAuthenticated) {
        saveLevelCompletion('ugy5').catch(console.warn)
      }
    } catch(e) {
      ...
      <div className="container">
        <header>
          <Link to="/" className="brand" aria-label="CyberMystery – Vissza a főoldalra">
            ...
            <div>A Rejtett Metaadat – Ügy #5</div>
          </Link>
        </header>
        <main>
          <div className="card" style={{textAlign:'center', padding:'40px 20px'}}>
            ...
            <p className="muted" style={{margin:'0 0 20px', fontSize:'16px', lineHeight:'1.7'}}>
              A 5. pálya csak az első két pálya teljesítése után érhető el.
              <br />
  ...
  return (
    <div className="container">
      ...
      <main>
        <NarrativeBlock badge="rejtett metaadat">
          <h1 style={{margin:'10px 0 4px'}}>A Rejtett Metaadat – Ügy #5</h1>
          ...
          <TaskCard title="1. feladat">
            <div className="grid2">
              ...
              <div className="card">
                ...
                />
                <div className="task-note"><PerfImg className="task-ill" src="/images/5a.jpg" alt="Illusztráció 5a" width="280" height="280" priority /></div>
                <div className="hint">
                  <details>
          ...
          <TaskCard title="2. feladat">
            <div className="grid2">
              ...
              <div className="card">
                ...
                <div className="task-note"><PerfImg className="task-ill" src="/images/5b.jpg" alt="Illusztráció 5b" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
          ...
          <TaskCard title="3. feladat">
            <div className="grid2">
              ...
              <div className="card">
                <h3>Válasz</h3>
                <ChallengeInput placeholder="megoldás…" onCheck={() => false} />
                <div className="task-note"><PerfImg className="task-ill" src="/images/5c.jpg" alt="Illusztráció 5c" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
          ...
          <TaskCard title="4. feladat">
            <div className="grid2">
              ...
              <div className="card">
                <h3>Válasz</h3>
                <ChallengeInput placeholder="megoldás…" onCheck={() => false} />
                <div className="task-note"><PerfImg className="task-ill" src="/images/5d.jpg" alt="Illusztráció 5d" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
          ...
          <TaskCard title="5. feladat">
            <div className="grid2">
              ...
              <div className="card">
                <h3>Válasz</h3>
                <ChallengeInput placeholder="megoldás…" onCheck={() => false} />
                <div className="task-note"><PerfImg className="task-ill" src="/images/5e.jpg" alt="Illusztráció 5e" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
                    onClick={() => { 
                      markDone(4); 
                      try {
                        localStorage.setItem('ugy5_completed', 'true');
                        if (isAuthenticated) {
                          saveLevelCompletion('ugy5').catch(console.warn)
                        }
                      } catch(e) {
                ...
                {done[4] && (
                  <div className="card" style={{marginTop:'10px', animation:'fadeIn .3s ease both'}}>
                    <div style={{display:'flex', gap:'10px', marginTop:'8px', flexWrap:'wrap'}}>
                      ...
                      <Link className="btn-ghost" to="/ugy4" style={{textDecoration:'none'}}>Előző ügy</Link>
                      <Link className="btn-ghost" to="/ugy6?start=1" style={{textDecoration:'none'}}>Következő ügy</Link>
                    </div>
                  </div>
                )}
              </div>
