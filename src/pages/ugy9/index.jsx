...
const STORAGE_KEY = 'ugy9_progress';
const STORAGE_COMPLETED_KEY = 'ugy9_completed';
...
function saveProgress(step, done) {
  try {
    ...
    if (window.CMAuth && window.CMAuth.isAuthenticated) {
      window.CMAuth.saveLevelCompletion('ugy9');
    }
  } catch(e) {
...
const App = () => {
  ...
  useEffect(()=>{
    const STEP_IMAGES = ['/images/9a.jpg','/images/9b.jpg','/images/9c.jpg','/images/9d.jpg','/images/9e.jpg'];
    const next = step + 1;
      ...
      <div className="container">
        <header>
          <a href="/" className="brand" aria-label="CyberMystery – Vissza a főoldalra">
            ...
            <div>A Megszakított Átvitel – Ügy #9</div>
          </a>
        </header>
        <main>
          <div className="card" style={{textAlign:'center', padding:'40px 20px'}}>
            ...
            <p className="muted" style={{margin:'0 0 20px', fontSize:'16px', lineHeight:'1.7'}}>
              A 9. pálya csak az első két pálya teljesítése után érhető el.
              <br />
  ...
  return (
    <div className="container">
      ...
      <main>
        <NarrativeBlock badge="megszakított átvitel">
          <h1 style={{margin:'10px 0 4px'}}>A Megszakított Átvitel – Ügy #9</h1>
          ...
          <TaskCard title="1. feladat">
            <div className="grid2">
              ...
              <div className="card">
                ...
                />
                <div className="task-note"><PerfImg className="task-ill" src="/images/9a.jpg" alt="Illusztráció 9a" width="280" height="280" priority /></div>
                <div className="hint">
                  <details>
          ...
          <TaskCard title="2. feladat">
            <div className="grid2">
              ...
              <div className="card">
                ...
                <div className="task-note"><PerfImg className="task-ill" src="/images/9b.jpg" alt="Illusztráció 9b" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
          ...
          <TaskCard title="3. feladat">
            <div className="grid2">
              ...
              <div className="card">
                <h3>Válasz</h3>
                <ChallengeInput placeholder="megoldás…" onCheck={() => false} />
                <div className="task-note"><PerfImg className="task-ill" src="/images/9c.jpg" alt="Illusztráció 9c" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
          ...
          <TaskCard title="4. feladat">
            <div className="grid2">
              ...
              <div className="card">
                <h3>Válasz</h3>
                <ChallengeInput placeholder="megoldás…" onCheck={() => false} />
                <div className="task-note"><PerfImg className="task-ill" src="/images/9d.jpg" alt="Illusztráció 9d" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
          ...
          <TaskCard title="5. feladat">
            <div className="grid2">
              ...
              <div className="card">
                <h3>Válasz</h3>
                <ChallengeInput placeholder="megoldás…" onCheck={() => false} />
                <div className="task-note"><PerfImg className="task-ill" src="/images/9e.jpg" alt="Illusztráció 9e" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
                    onClick={() => { 
                      markDone(4); 
                      try {
                        localStorage.setItem('ugy9_completed', 'true');
                        if (window.CMAuth && window.CMAuth.isAuthenticated) {
                          window.CMAuth.saveLevelCompletion('ugy9');
                        }
                      } catch(e) {
                ...
                {done[4] && (
                  <div className="card" style={{marginTop:'10px', animation:'fadeIn .3s ease both'}}>
                    <div style={{display:'flex', gap:'10px', marginTop:'8px', flexWrap:'wrap'}}>
                      ...
                      <a className="btn-ghost" href="/ugy8.html" style={{textDecoration:'none'}}>Előző ügy</a>
                      <a className="btn-ghost" href="/ugy10.html?start=1" style={{textDecoration:'none'}}>Következő ügy</a>
                    </div>
                  </div>
                )}
              </div>
