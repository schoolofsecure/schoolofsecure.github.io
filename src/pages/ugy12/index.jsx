...
const STORAGE_KEY = 'ugy12_progress';
const STORAGE_COMPLETED_KEY = 'ugy12_completed';
...
function saveProgress(step, done) {
  try {
    ...
    if (window.CMAuth && window.CMAuth.isAuthenticated) {
      window.CMAuth.saveLevelCompletion('ugy12');
    }
  } catch(e) {
...
const App = () => {
  ...
  useEffect(()=>{
    const STEP_IMAGES = ['/images/12a.jpg','/images/12b.jpg','/images/12c.jpg','/images/12d.jpg','/images/12e.jpg'];
    const next = step + 1;
        ...
        <main>
          <div className="card" style={{textAlign:'center', padding:'40px 20px'}}>
            ...
            <p className="muted" style={{margin:'0 0 20px', fontSize:'16px', lineHeight:'1.7'}}>
              A 12. pálya csak az első két pálya teljesítése után érhető el.
              <br />
  ...
  return (
    <div className="container">
      ...
      <main>
        <NarrativeBlock badge="főkolompos">
          <h1 style={{margin:'10px 0 4px'}}>A Főkolompos – Ügy #12</h1>
          ...
          <TaskCard title="1. feladat">
            <div className="grid2">
              <div className="card">
                <h3>Első feladat</h3>
                <p className="muted">
                  Ez az első feladat a 12. pályán. 
              ...
              <div className="card">
                ...
                />
                <div className="task-note"><PerfImg className="task-ill" src="/images/12a.jpg" alt="Illusztráció 12a" width="280" height="280" priority /></div>
                <div className="hint">
                  <details>
          ...
          <TaskCard title="2. feladat">
            <div className="grid2">
              ...
              <div className="card">
                ...
                <div className="task-note"><PerfImg className="task-ill" src="/images/12b.jpg" alt="Illusztráció 12b" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
          ...
          <TaskCard title="3. feladat">
            <div className="grid2">
              ...
              <div className="card">
                <h3>Válasz</h3>
                <ChallengeInput placeholder="megoldás…" onCheck={() => false} />
                <div className="task-note"><PerfImg className="task-ill" src="/images/12c.jpg" alt="Illusztráció 12c" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
          ...
          <TaskCard title="4. feladat">
            <div className="grid2">
              ...
              <div className="card">
                <h3>Válasz</h3>
                <ChallengeInput placeholder="megoldás…" onCheck={() => false} />
                <div className="task-note"><PerfImg className="task-ill" src="/images/12d.jpg" alt="Illusztráció 12d" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
          ...
          <TaskCard title="5. feladat">
            <div className="grid2">
              ...
              <div className="card">
                <h3>Válasz</h3>
                <ChallengeInput placeholder="megoldás…" onCheck={() => false} />
                <div className="task-note"><PerfImg className="task-ill" src="/images/12e.jpg" alt="Illusztráció 12e" width="280" height="280" priority /></div>
                {/* Fejlesztői gombok */}
                <div style={{marginTop:'16px', paddingTop:'16px', borderTop:'1px solid rgba(207,230,255,0.2)', display:'flex', gap:'8px', flexWrap:'wrap'}}>
                  <button 
                    className="btn-ghost" 
                    onClick={() => { 
                      markDone(4); 
                      try {
                        localStorage.setItem('ugy12_completed', 'true');
                        if (window.CMAuth && window.CMAuth.isAuthenticated) {
                          window.CMAuth.saveLevelCompletion('ugy12');
                        }
                      } catch(e) {
                ...
                {done[4] && (
                  <div className="card" style={{marginTop:'10px', animation:'fadeIn .3s ease both'}}>
                    <div style={{display:'flex', gap:'10px', marginTop:'8px', flexWrap:'wrap'}}>
                      ...
                      <a className="btn-ghost" href="/ugy11.html" style={{textDecoration:'none'}}>Előző ügy</a>
                    </div>
                  </div>
                )}
              </div>
